...
#define DEF_STEP_UP_EARLY_HISPEED		(480000)
#define DEF_STEP_UP_INTERIM_HISPEED		(902400)
...
#define SUP_SLOW_UP_FREQUENCY 		(480000)
#define SUP_HIGH_SLOW_UP_FREQUENCY 	(902400)
...
static int two_phase_freq_array[NR_CPUS] = {[0 ... NR_CPUS-1] = 806400} ;
